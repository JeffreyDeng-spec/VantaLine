...
- `local_inspection_service/model_providers/`: OpenAI-compatible and Gemini transports, explicit capabilities, shared error types and payload/error parsing without importing the Web application.
