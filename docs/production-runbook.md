...
original pass flag. Deploy or roll back all three layout modules and source manifest v27 together.
...
with matching source manifest v27 as a complete release.
...
source manifest v27; do not copy individual catalog files into production.
...
restore the complete package with matching source manifest v27.
...
label-detection timeout/late-response rules. Restore the complete package with manifest v27.
...
v27 manifest; do not repair a rollout by copying individual generation files.
...
original step order. Deploy/restore all matching modules and source manifest v27 together.
...
Ship/restore the matching v27 manifest and modules together; historical snapshots are retained.
...
runtime records and deploy both new modules with source manifest v27.
...
source manifest v27. Existing records and historical model snapshots are preserved.
...
no thread coordination or lifecycle idempotence; deploy/restore manifest v27 and all
...
warmup threads or restart behavior. Roll back the complete package with manifest v27.
...
source manifest v27 with the entire immutable release.
...
parameters. Deploy/rollback all OCR modules and manifest v27 as one complete release.
...
with matching manifest v27, retaining historical snapshots. This batch does not
