...
source manifest v15. Existing records and historical model snapshots are preserved.
...
no thread coordination or lifecycle idempotence; deploy/restore manifest v15 and all
...
warmup threads or restart behavior. Roll back the complete package with manifest v15.
...
source manifest v15 with the entire immutable release.
...
parameters. Deploy/rollback all OCR modules and manifest v15 as one complete release.
...
with matching manifest v15, retaining historical snapshots. This batch does not
