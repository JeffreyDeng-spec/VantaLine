...
modules with matching source manifest v79 as one complete release.
...
Deploy/rollback the complete workflow package with matching source manifest v79.
...
Deploy or restore the renderer and its ports with matching source manifest v79 together.
...
original pass flag. Deploy or roll back all three layout modules and source manifest v79 together.
...
with matching source manifest v79 as a complete release.
...
source manifest v79; do not copy individual catalog files into production.
...
restore the complete package with matching source manifest v79.
...
label-detection timeout/late-response rules. Restore the complete package with manifest v79.
...
v79 manifest; do not repair a rollout by copying individual generation files.
...
original step order. Deploy/restore all matching modules and source manifest v79 together.
...
Ship/restore the matching v79 manifest and modules together; historical snapshots are retained.
...
runtime records and deploy both new modules with source manifest v79.
...
source manifest v79. Existing records and historical model snapshots are preserved.
...
no thread coordination or lifecycle idempotence; deploy/restore manifest v79 and all
...
warmup threads or restart behavior. Roll back the complete package with manifest v79.
...
source manifest v79 with the entire immutable release.
...
parameters. Deploy/rollback all OCR modules and manifest v79 as one complete release.
...
with matching manifest v79, retaining historical snapshots. This batch does not
