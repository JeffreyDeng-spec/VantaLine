...
modules with matching source manifest v34 as one complete release.
...
Deploy/rollback the complete workflow package with matching source manifest v34.
...
Deploy or restore the renderer and its ports with matching source manifest v34 together.
...
original pass flag. Deploy or roll back all three layout modules and source manifest v34 together.
...
with matching source manifest v34 as a complete release.
...
source manifest v34; do not copy individual catalog files into production.
...
restore the complete package with matching source manifest v34.
...
label-detection timeout/late-response rules. Restore the complete package with manifest v34.
...
v34 manifest; do not repair a rollout by copying individual generation files.
...
original step order. Deploy/restore all matching modules and source manifest v34 together.
...
Ship/restore the matching v34 manifest and modules together; historical snapshots are retained.
...
runtime records and deploy both new modules with source manifest v34.
...
source manifest v34. Existing records and historical model snapshots are preserved.
...
no thread coordination or lifecycle idempotence; deploy/restore manifest v34 and all
...
warmup threads or restart behavior. Roll back the complete package with manifest v34.
...
source manifest v34 with the entire immutable release.
...
parameters. Deploy/rollback all OCR modules and manifest v34 as one complete release.
...
with matching manifest v34, retaining historical snapshots. This batch does not
