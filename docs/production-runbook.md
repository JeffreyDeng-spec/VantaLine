...
modules with matching source manifest v47 as one complete release.
...
Deploy/rollback the complete workflow package with matching source manifest v47.
...
Deploy or restore the renderer and its ports with matching source manifest v47 together.
...
original pass flag. Deploy or roll back all three layout modules and source manifest v47 together.
...
with matching source manifest v47 as a complete release.
...
source manifest v47; do not copy individual catalog files into production.
...
restore the complete package with matching source manifest v47.
...
label-detection timeout/late-response rules. Restore the complete package with manifest v47.
...
v47 manifest; do not repair a rollout by copying individual generation files.
...
original step order. Deploy/restore all matching modules and source manifest v47 together.
...
Ship/restore the matching v47 manifest and modules together; historical snapshots are retained.
...
runtime records and deploy both new modules with source manifest v47.
...
source manifest v47. Existing records and historical model snapshots are preserved.
...
no thread coordination or lifecycle idempotence; deploy/restore manifest v47 and all
...
warmup threads or restart behavior. Roll back the complete package with manifest v47.
...
source manifest v47 with the entire immutable release.
...
parameters. Deploy/rollback all OCR modules and manifest v47 as one complete release.
...
with matching manifest v47, retaining historical snapshots. This batch does not
