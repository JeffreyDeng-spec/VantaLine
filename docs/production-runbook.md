...
modules with matching source manifest v41 as one complete release.
...
Deploy/rollback the complete workflow package with matching source manifest v41.
...
Deploy or restore the renderer and its ports with matching source manifest v41 together.
...
original pass flag. Deploy or roll back all three layout modules and source manifest v41 together.
...
with matching source manifest v41 as a complete release.
...
source manifest v41; do not copy individual catalog files into production.
...
restore the complete package with matching source manifest v41.
...
label-detection timeout/late-response rules. Restore the complete package with manifest v41.
...
v41 manifest; do not repair a rollout by copying individual generation files.
...
original step order. Deploy/restore all matching modules and source manifest v41 together.
...
Ship/restore the matching v41 manifest and modules together; historical snapshots are retained.
...
runtime records and deploy both new modules with source manifest v41.
...
source manifest v41. Existing records and historical model snapshots are preserved.
...
no thread coordination or lifecycle idempotence; deploy/restore manifest v41 and all
...
warmup threads or restart behavior. Roll back the complete package with manifest v41.
...
source manifest v41 with the entire immutable release.
...
parameters. Deploy/rollback all OCR modules and manifest v41 as one complete release.
...
with matching manifest v41, retaining historical snapshots. This batch does not
