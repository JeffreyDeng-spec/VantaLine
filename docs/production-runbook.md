...
modules with matching source manifest v85 as one complete release.
...
Deploy/rollback the complete workflow package with matching source manifest v85.
...
Deploy or restore the renderer and its ports with matching source manifest v85 together.
...
original pass flag. Deploy or roll back all three layout modules and source manifest v85 together.
...
with matching source manifest v85 as a complete release.
...
source manifest v85; do not copy individual catalog files into production.
...
restore the complete package with matching source manifest v85.
...
label-detection timeout/late-response rules. Restore the complete package with manifest v85.
...
v85 manifest; do not repair a rollout by copying individual generation files.
...
original step order. Deploy/restore all matching modules and source manifest v85 together.
...
Ship/restore the matching v85 manifest and modules together; historical snapshots are retained.
...
runtime records and deploy both new modules with source manifest v85.
...
source manifest v85. Existing records and historical model snapshots are preserved.
...
no thread coordination or lifecycle idempotence; deploy/restore manifest v85 and all
...
warmup threads or restart behavior. Roll back the complete package with manifest v85.
...
source manifest v85 with the entire immutable release.
...
parameters. Deploy/rollback all OCR modules and manifest v85 as one complete release.
...
with matching manifest v85, retaining historical snapshots. This batch does not
