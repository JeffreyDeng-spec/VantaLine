...
Manifest v45 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v45 includes both
...
`accessories/preparation.py`, included in source manifest v45 for new tasks.
