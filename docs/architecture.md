...
Manifest v72 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v72 includes both
...
`accessories/preparation.py`, included in source manifest v72 for new tasks.
