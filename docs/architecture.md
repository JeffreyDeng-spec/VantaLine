...
Manifest v59 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v59 includes both
...
`accessories/preparation.py`, included in source manifest v59 for new tasks.
