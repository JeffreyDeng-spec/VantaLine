...
Manifest v83 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v83 includes both
...
`accessories/preparation.py`, included in source manifest v83 for new tasks.
