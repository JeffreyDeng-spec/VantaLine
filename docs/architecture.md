...
Manifest v67 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v67 includes both
...
`accessories/preparation.py`, included in source manifest v67 for new tasks.
