...
Manifest v80 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v80 includes both
...
`accessories/preparation.py`, included in source manifest v80 for new tasks.
