...
Manifest v54 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v54 includes both
...
`accessories/preparation.py`, included in source manifest v54 for new tasks.
