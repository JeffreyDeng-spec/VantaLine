...
perform no I/O. Agnes and Qwen implementations and their decorators remain unchanged.
...
Manifest v57 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v57 includes both
...
`accessories/preparation.py`, included in source manifest v57 for new tasks.
