...
Manifest v33 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v33 includes both
...
`accessories/preparation.py`, included in source manifest v33 for new tasks.
