...
Manifest v79 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v79 includes both
...
`accessories/preparation.py`, included in source manifest v79 for new tasks.
