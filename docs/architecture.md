...
Manifest v74 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v74 includes both
...
`accessories/preparation.py`, included in source manifest v74 for new tasks.
