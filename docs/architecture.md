...
Manifest v46 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v46 includes both
...
`accessories/preparation.py`, included in source manifest v46 for new tasks.
