...
Manifest v11 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v11 includes both
...
`accessories/preparation.py`, included in source manifest v11 for new tasks.
