...
Manifest v47 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v47 includes both
...
`accessories/preparation.py`, included in source manifest v47 for new tasks.
