...
Manifest v89 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v89 includes both
...
`accessories/preparation.py`, included in source manifest v89 for new tasks.
