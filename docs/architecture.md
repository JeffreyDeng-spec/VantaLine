...
Manifest v76 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v76 includes both
...
`accessories/preparation.py`, included in source manifest v76 for new tasks.
