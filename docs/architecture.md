...
Manifest v95 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v95 includes both
...
`accessories/preparation.py`, included in source manifest v95 for new tasks.
