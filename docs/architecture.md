...
Manifest v48 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v48 includes both
...
`accessories/preparation.py`, included in source manifest v48 for new tasks.
