...
Manifest v49 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v49 includes both
...
`accessories/preparation.py`, included in source manifest v49 for new tasks.
