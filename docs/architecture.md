...
Manifest v82 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v82 includes both
...
`accessories/preparation.py`, included in source manifest v82 for new tasks.
