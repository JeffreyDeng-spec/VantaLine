...
Manifest v81 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v81 includes both
...
`accessories/preparation.py`, included in source manifest v81 for new tasks.
