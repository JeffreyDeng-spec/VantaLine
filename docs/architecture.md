...
Manifest v50 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v50 includes both
...
`accessories/preparation.py`, included in source manifest v50 for new tasks.
