...
Manifest v99 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v99 includes both
...
`accessories/preparation.py`, included in source manifest v99 for new tasks.
