...
Manifest v58 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v58 includes both
...
`accessories/preparation.py`, included in source manifest v58 for new tasks.
