...
Manifest v101 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v101 includes both
...
`accessories/preparation.py`, included in source manifest v101 for new tasks.
