...
Manifest v19 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v19 includes both
...
`accessories/preparation.py`, included in source manifest v19 for new tasks.
