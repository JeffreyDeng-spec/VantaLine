...
Manifest v27 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v27 includes both
...
`accessories/preparation.py`, included in source manifest v27 for new tasks.
