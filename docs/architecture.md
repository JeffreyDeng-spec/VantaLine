...
Manifest v38 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v38 includes both
...
`accessories/preparation.py`, included in source manifest v38 for new tasks.
