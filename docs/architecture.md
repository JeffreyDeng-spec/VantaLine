...
Manifest v16 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v16 includes both
...
`accessories/preparation.py`, included in source manifest v16 for new tasks.
