...
Manifest v92 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v92 includes both
...
`accessories/preparation.py`, included in source manifest v92 for new tasks.
