...
Manifest v86 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v86 includes both
...
`accessories/preparation.py`, included in source manifest v86 for new tasks.
