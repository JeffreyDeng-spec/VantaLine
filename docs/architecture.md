...
Manifest v60 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v60 includes both
...
`accessories/preparation.py`, included in source manifest v60 for new tasks.
