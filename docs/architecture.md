...
Manifest v51 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v51 includes both
...
`accessories/preparation.py`, included in source manifest v51 for new tasks.
