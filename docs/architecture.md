...
Manifest v100 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v100 includes both
...
`accessories/preparation.py`, included in source manifest v100 for new tasks.
