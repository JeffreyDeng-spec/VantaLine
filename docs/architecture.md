...
Manifest v68 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v68 includes both
...
`accessories/preparation.py`, included in source manifest v68 for new tasks.
