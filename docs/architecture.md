...
Manifest v73 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v73 includes both
...
`accessories/preparation.py`, included in source manifest v73 for new tasks.
