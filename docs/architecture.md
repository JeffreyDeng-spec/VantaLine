...
Manifest v69 includes these five modules so relocation retains source provenance.
...
policy or callback caching is introduced. Source manifest v69 includes both
...
`accessories/preparation.py`, included in source manifest v69 for new tasks.
