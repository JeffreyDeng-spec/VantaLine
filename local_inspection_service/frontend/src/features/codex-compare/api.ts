...
export interface Task {
  ...
  inputs: { standard_name: string; standard_revision_id: string; standard_revision_number: number; reference: Evidence; actual: Evidence };
...
export const labels: Record<string, string> = { queued: '排队中', running: '核对中', cancel_requested: '正在取消', completed: '已完成', failed: '失败', timed_out: '超时', cancelled: '已取消', interrupted: '运行中断', match: '一致', difference: '差异', uncertain: '待确认', MATCH: '一致', DIFFERENCES: '存在差异', REVIEW_REQUIRED: '无法确认' };
