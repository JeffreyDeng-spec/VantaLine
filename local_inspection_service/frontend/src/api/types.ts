...
export type PlcSyncState = "disabled" | "queued" | "attempting" | "sent" | "acknowledged" | "failed";
...
export type PlcChecksumMode = "exclude_etx_legacy_vb" | "include_etx_documented_comment";
