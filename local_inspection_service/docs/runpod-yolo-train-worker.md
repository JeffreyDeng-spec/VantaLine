...
metadata ordering, cleanup and failure residue are retained. Source manifest v36 includes these producers.
...
retry or cancel is added. Source manifest v36 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v36 covers those relocated producers. No worker
...
source fingerprints use manifest v36, while historical task references remain untouched.
