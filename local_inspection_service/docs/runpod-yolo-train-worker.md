...
metadata ordering, cleanup and failure residue are retained. Source manifest v26 includes these producers.
...
retry or cancel is added. Source manifest v26 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v26 covers those relocated producers. No worker
...
source fingerprints use manifest v26, while historical task references remain untouched.
