...
metadata ordering, cleanup and failure residue are retained. Source manifest v46 includes these producers.
...
retry or cancel is added. Source manifest v46 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v46 covers those relocated producers. No worker
...
source fingerprints use manifest v46, while historical task references remain untouched.
