...
metadata ordering, cleanup and failure residue are retained. Source manifest v59 includes these producers.
...
retry or cancel is added. Source manifest v59 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v59 covers those relocated producers. No worker
...
source fingerprints use manifest v59, while historical task references remain untouched.
