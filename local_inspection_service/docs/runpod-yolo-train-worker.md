...
metadata ordering, cleanup and failure residue are retained. Source manifest v38 includes these producers.
...
retry or cancel is added. Source manifest v38 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v38 covers those relocated producers. No worker
...
source fingerprints use manifest v38, while historical task references remain untouched.
