...
metadata ordering, cleanup and failure residue are retained. Source manifest v51 includes these producers.
...
retry or cancel is added. Source manifest v51 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v51 covers those relocated producers. No worker
...
source fingerprints use manifest v51, while historical task references remain untouched.
