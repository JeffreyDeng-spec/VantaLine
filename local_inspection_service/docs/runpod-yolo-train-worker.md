...
metadata ordering, cleanup and failure residue are retained. Source manifest v61 includes these producers.
...
retry or cancel is added. Source manifest v61 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v61 covers those relocated producers. No worker
...
source fingerprints use manifest v61, while historical task references remain untouched.
