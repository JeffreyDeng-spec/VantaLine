...
metadata ordering, cleanup and failure residue are retained. Source manifest v72 includes these producers.
...
retry or cancel is added. Source manifest v72 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v72 covers those relocated producers. No worker
...
source fingerprints use manifest v72, while historical task references remain untouched.
