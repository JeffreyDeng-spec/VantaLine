...
metadata ordering, cleanup and failure residue are retained. Source manifest v99 includes these producers.
...
retry or cancel is added. Source manifest v99 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v99 covers those relocated producers. No worker
...
source fingerprints use manifest v99, while historical task references remain untouched.
