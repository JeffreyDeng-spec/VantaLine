...
metadata ordering, cleanup and failure residue are retained. Source manifest v89 includes these producers.
...
retry or cancel is added. Source manifest v89 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v89 covers those relocated producers. No worker
...
source fingerprints use manifest v89, while historical task references remain untouched.
