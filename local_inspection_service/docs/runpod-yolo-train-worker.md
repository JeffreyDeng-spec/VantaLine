...
metadata ordering, cleanup and failure residue are retained. Source manifest v67 includes these producers.
...
retry or cancel is added. Source manifest v67 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v67 covers those relocated producers. No worker
...
source fingerprints use manifest v67, while historical task references remain untouched.
