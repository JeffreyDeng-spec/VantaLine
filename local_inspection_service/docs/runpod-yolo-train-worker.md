...
metadata ordering, cleanup and failure residue are retained. Source manifest v48 includes these producers.
...
retry or cancel is added. Source manifest v48 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v48 covers those relocated producers. No worker
...
source fingerprints use manifest v48, while historical task references remain untouched.
