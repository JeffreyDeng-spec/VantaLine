...
retry or cancel is added. Source manifest v17 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v17 covers those relocated producers. No worker
...
source fingerprints use manifest v17, while historical task references remain untouched.
