...
metadata ordering, cleanup and failure residue are retained. Source manifest v87 includes these producers.
...
retry or cancel is added. Source manifest v87 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v87 covers those relocated producers. No worker
...
source fingerprints use manifest v87, while historical task references remain untouched.
