...
metadata ordering, cleanup and failure residue are retained. Source manifest v25 includes these producers.
...
retry or cancel is added. Source manifest v25 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v25 covers those relocated producers. No worker
...
source fingerprints use manifest v25, while historical task references remain untouched.
