...
metadata ordering, cleanup and failure residue are retained. Source manifest v93 includes these producers.
...
retry or cancel is added. Source manifest v93 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v93 covers those relocated producers. No worker
...
source fingerprints use manifest v93, while historical task references remain untouched.
