...
metadata ordering, cleanup and failure residue are retained. Source manifest v41 includes these producers.
...
retry or cancel is added. Source manifest v41 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v41 covers those relocated producers. No worker
...
source fingerprints use manifest v41, while historical task references remain untouched.
