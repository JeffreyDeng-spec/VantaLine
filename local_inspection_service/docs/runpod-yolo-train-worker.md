...
metadata ordering, cleanup and failure residue are retained. Source manifest v34 includes these producers.
...
retry or cancel is added. Source manifest v34 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v34 covers those relocated producers. No worker
...
source fingerprints use manifest v34, while historical task references remain untouched.
