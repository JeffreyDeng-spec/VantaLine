...
metadata ordering, cleanup and failure residue are retained. Source manifest v55 includes these producers.
...
retry or cancel is added. Source manifest v55 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v55 covers those relocated producers. No worker
...
source fingerprints use manifest v55, while historical task references remain untouched.
