...
metadata ordering, cleanup and failure residue are retained. Source manifest v73 includes these producers.
...
retry or cancel is added. Source manifest v73 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v73 covers those relocated producers. No worker
...
source fingerprints use manifest v73, while historical task references remain untouched.
