...
metadata ordering, cleanup and failure residue are retained. Source manifest v64 includes these producers.
...
retry or cancel is added. Source manifest v64 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v64 covers those relocated producers. No worker
...
source fingerprints use manifest v64, while historical task references remain untouched.
