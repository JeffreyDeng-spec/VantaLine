...
metadata ordering, cleanup and failure residue are retained. Source manifest v94 includes these producers.
...
retry or cancel is added. Source manifest v94 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v94 covers those relocated producers. No worker
...
source fingerprints use manifest v94, while historical task references remain untouched.
