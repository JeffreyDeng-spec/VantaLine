...
metadata ordering, cleanup and failure residue are retained. Source manifest v97 includes these producers.
...
retry or cancel is added. Source manifest v97 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v97 covers those relocated producers. No worker
...
source fingerprints use manifest v97, while historical task references remain untouched.
