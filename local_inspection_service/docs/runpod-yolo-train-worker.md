...
metadata ordering, cleanup and failure residue are retained. Source manifest v24 includes these producers.
...
retry or cancel is added. Source manifest v24 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v24 covers those relocated producers. No worker
...
source fingerprints use manifest v24, while historical task references remain untouched.
