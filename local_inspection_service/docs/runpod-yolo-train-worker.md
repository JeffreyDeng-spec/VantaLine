...
metadata ordering, cleanup and failure residue are retained. Source manifest v30 includes these producers.
...
retry or cancel is added. Source manifest v30 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v30 covers those relocated producers. No worker
...
source fingerprints use manifest v30, while historical task references remain untouched.
