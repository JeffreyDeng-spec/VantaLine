...
metadata ordering, cleanup and failure residue are retained. Source manifest v71 includes these producers.
...
retry or cancel is added. Source manifest v71 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v71 covers those relocated producers. No worker
...
source fingerprints use manifest v71, while historical task references remain untouched.
