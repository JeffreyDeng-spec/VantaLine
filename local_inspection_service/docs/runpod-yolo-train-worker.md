...
metadata ordering, cleanup and failure residue are retained. Source manifest v88 includes these producers.
...
retry or cancel is added. Source manifest v88 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v88 covers those relocated producers. No worker
...
source fingerprints use manifest v88, while historical task references remain untouched.
