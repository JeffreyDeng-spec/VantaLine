...
metadata ordering, cleanup and failure residue are retained. Source manifest v29 includes these producers.
...
retry or cancel is added. Source manifest v29 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v29 covers those relocated producers. No worker
...
source fingerprints use manifest v29, while historical task references remain untouched.
