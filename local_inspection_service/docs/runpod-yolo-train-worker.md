...
metadata ordering, cleanup and failure residue are retained. Source manifest v76 includes these producers.
...
retry or cancel is added. Source manifest v76 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v76 covers those relocated producers. No worker
...
source fingerprints use manifest v76, while historical task references remain untouched.
