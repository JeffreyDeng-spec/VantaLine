...
metadata ordering, cleanup and failure residue are retained. Source manifest v95 includes these producers.
...
retry or cancel is added. Source manifest v95 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v95 covers those relocated producers. No worker
...
source fingerprints use manifest v95, while historical task references remain untouched.
