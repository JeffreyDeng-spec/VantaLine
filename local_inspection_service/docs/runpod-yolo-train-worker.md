...
metadata ordering, cleanup and failure residue are retained. Source manifest v81 includes these producers.
...
retry or cancel is added. Source manifest v81 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v81 covers those relocated producers. No worker
...
source fingerprints use manifest v81, while historical task references remain untouched.
