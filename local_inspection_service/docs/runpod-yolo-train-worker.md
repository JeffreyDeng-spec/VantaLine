...
metadata ordering, cleanup and failure residue are retained. Source manifest v78 includes these producers.
...
retry or cancel is added. Source manifest v78 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v78 covers those relocated producers. No worker
...
source fingerprints use manifest v78, while historical task references remain untouched.
