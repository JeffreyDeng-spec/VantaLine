...
metadata ordering, cleanup and failure residue are retained. Source manifest v77 includes these producers.
...
retry or cancel is added. Source manifest v77 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v77 covers those relocated producers. No worker
...
source fingerprints use manifest v77, while historical task references remain untouched.
