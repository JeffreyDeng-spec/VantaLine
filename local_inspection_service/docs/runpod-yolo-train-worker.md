...
metadata ordering, cleanup and failure residue are retained. Source manifest v70 includes these producers.
...
retry or cancel is added. Source manifest v70 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v70 covers those relocated producers. No worker
...
source fingerprints use manifest v70, while historical task references remain untouched.
