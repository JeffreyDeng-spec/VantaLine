...
metadata ordering, cleanup and failure residue are retained. Source manifest v32 includes these producers.
...
retry or cancel is added. Source manifest v32 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v32 covers those relocated producers. No worker
...
source fingerprints use manifest v32, while historical task references remain untouched.
