...
metadata ordering, cleanup and failure residue are retained. Source manifest v91 includes these producers.
...
retry or cancel is added. Source manifest v91 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v91 covers those relocated producers. No worker
...
source fingerprints use manifest v91, while historical task references remain untouched.
