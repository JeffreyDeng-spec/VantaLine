...
metadata ordering, cleanup and failure residue are retained. Source manifest v45 includes these producers.
...
retry or cancel is added. Source manifest v45 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v45 covers those relocated producers. No worker
...
source fingerprints use manifest v45, while historical task references remain untouched.
