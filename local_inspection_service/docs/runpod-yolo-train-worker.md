...
metadata ordering, cleanup and failure residue are retained. Source manifest v60 includes these producers.
...
retry or cancel is added. Source manifest v60 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v60 covers those relocated producers. No worker
...
source fingerprints use manifest v60, while historical task references remain untouched.
