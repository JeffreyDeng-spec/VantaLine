...
metadata ordering, cleanup and failure residue are retained. Source manifest v100 includes these producers.
...
retry or cancel is added. Source manifest v100 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v100 covers those relocated producers. No worker
...
source fingerprints use manifest v100, while historical task references remain untouched.
