...
metadata ordering, cleanup and failure residue are retained. Source manifest v63 includes these producers.
...
retry or cancel is added. Source manifest v63 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v63 covers those relocated producers. No worker
...
source fingerprints use manifest v63, while historical task references remain untouched.
