...
metadata ordering, cleanup and failure residue are retained. Source manifest v49 includes these producers.
...
retry or cancel is added. Source manifest v49 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v49 covers those relocated producers. No worker
...
source fingerprints use manifest v49, while historical task references remain untouched.
