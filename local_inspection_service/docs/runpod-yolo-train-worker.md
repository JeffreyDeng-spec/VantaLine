...
metadata ordering, cleanup and failure residue are retained. Source manifest v96 includes these producers.
...
retry or cancel is added. Source manifest v96 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v96 covers those relocated producers. No worker
...
source fingerprints use manifest v96, while historical task references remain untouched.
