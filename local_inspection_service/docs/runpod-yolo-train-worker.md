...
metadata ordering, cleanup and failure residue are retained. Source manifest v50 includes these producers.
...
retry or cancel is added. Source manifest v50 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v50 covers those relocated producers. No worker
...
source fingerprints use manifest v50, while historical task references remain untouched.
