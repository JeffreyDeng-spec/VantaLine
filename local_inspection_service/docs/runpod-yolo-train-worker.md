...
metadata ordering, cleanup and failure residue are retained. Source manifest v85 includes these producers.
...
retry or cancel is added. Source manifest v85 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v85 covers those relocated producers. No worker
...
source fingerprints use manifest v85, while historical task references remain untouched.
