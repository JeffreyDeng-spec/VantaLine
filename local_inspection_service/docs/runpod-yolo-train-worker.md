...
metadata ordering, cleanup and failure residue are retained. Source manifest v47 includes these producers.
...
retry or cancel is added. Source manifest v47 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v47 covers those relocated producers. No worker
...
source fingerprints use manifest v47, while historical task references remain untouched.
