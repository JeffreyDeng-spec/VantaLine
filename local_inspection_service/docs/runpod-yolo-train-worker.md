...
metadata ordering, cleanup and failure residue are retained. Source manifest v74 includes these producers.
...
retry or cancel is added. Source manifest v74 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v74 covers those relocated producers. No worker
...
source fingerprints use manifest v74, while historical task references remain untouched.
