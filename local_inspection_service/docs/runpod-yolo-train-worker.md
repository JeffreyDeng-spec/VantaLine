...
metadata ordering, cleanup and failure residue are retained. Source manifest v52 includes these producers.
...
retry or cancel is added. Source manifest v52 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v52 covers those relocated producers. No worker
...
source fingerprints use manifest v52, while historical task references remain untouched.
