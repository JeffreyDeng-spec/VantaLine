...
metadata ordering, cleanup and failure residue are retained. Source manifest v84 includes these producers.
...
retry or cancel is added. Source manifest v84 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v84 covers those relocated producers. No worker
...
source fingerprints use manifest v84, while historical task references remain untouched.
