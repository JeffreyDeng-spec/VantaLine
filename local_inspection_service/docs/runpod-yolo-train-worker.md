...
metadata ordering, cleanup and failure residue are retained. Source manifest v82 includes these producers.
...
retry or cancel is added. Source manifest v82 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v82 covers those relocated producers. No worker
...
source fingerprints use manifest v82, while historical task references remain untouched.
