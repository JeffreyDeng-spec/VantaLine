...
metadata ordering, cleanup and failure residue are retained. Source manifest v90 includes these producers.
...
retry or cancel is added. Source manifest v90 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v90 covers those relocated producers. No worker
...
source fingerprints use manifest v90, while historical task references remain untouched.
