...
metadata ordering, cleanup and failure residue are retained. Source manifest v40 includes these producers.
...
retry or cancel is added. Source manifest v40 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v40 covers those relocated producers. No worker
...
source fingerprints use manifest v40, while historical task references remain untouched.
