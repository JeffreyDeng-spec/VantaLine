...
metadata ordering, cleanup and failure residue are retained. Source manifest v62 includes these producers.
...
retry or cancel is added. Source manifest v62 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v62 covers those relocated producers. No worker
...
source fingerprints use manifest v62, while historical task references remain untouched.
