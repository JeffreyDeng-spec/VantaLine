...
metadata ordering, cleanup and failure residue are retained. Source manifest v68 includes these producers.
...
retry or cancel is added. Source manifest v68 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v68 covers those relocated producers. No worker
...
source fingerprints use manifest v68, while historical task references remain untouched.
