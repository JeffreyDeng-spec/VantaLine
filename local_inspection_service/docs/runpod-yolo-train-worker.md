...
metadata ordering, cleanup and failure residue are retained. Source manifest v33 includes these producers.
...
retry or cancel is added. Source manifest v33 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v33 covers those relocated producers. No worker
...
source fingerprints use manifest v33, while historical task references remain untouched.
