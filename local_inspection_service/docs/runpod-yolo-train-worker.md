...
metadata ordering, cleanup and failure residue are retained. Source manifest v69 includes these producers.
...
retry or cancel is added. Source manifest v69 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v69 covers those relocated producers. No worker
...
source fingerprints use manifest v69, while historical task references remain untouched.
