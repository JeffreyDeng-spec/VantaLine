...
metadata ordering, cleanup and failure residue are retained. Source manifest v57 includes these producers.
...
retry or cancel is added. Source manifest v57 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v57 covers those relocated producers. No worker
...
source fingerprints use manifest v57, while historical task references remain untouched.
