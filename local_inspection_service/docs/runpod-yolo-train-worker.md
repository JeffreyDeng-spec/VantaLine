...
metadata ordering, cleanup and failure residue are retained. Source manifest v31 includes these producers.
...
retry or cancel is added. Source manifest v31 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v31 covers those relocated producers. No worker
...
source fingerprints use manifest v31, while historical task references remain untouched.
