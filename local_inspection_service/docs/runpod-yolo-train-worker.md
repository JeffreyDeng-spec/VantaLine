...
metadata ordering, cleanup and failure residue are retained. Source manifest v75 includes these producers.
...
retry or cancel is added. Source manifest v75 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v75 covers those relocated producers. No worker
...
source fingerprints use manifest v75, while historical task references remain untouched.
