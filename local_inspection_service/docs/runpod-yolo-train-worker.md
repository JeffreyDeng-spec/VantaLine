...
metadata ordering, cleanup and failure residue are retained. Source manifest v39 includes these producers.
...
retry or cancel is added. Source manifest v39 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v39 covers those relocated producers. No worker
...
source fingerprints use manifest v39, while historical task references remain untouched.
