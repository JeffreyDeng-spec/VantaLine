...
metadata ordering, cleanup and failure residue are retained. Source manifest v54 includes these producers.
...
retry or cancel is added. Source manifest v54 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v54 covers those relocated producers. No worker
...
source fingerprints use manifest v54, while historical task references remain untouched.
