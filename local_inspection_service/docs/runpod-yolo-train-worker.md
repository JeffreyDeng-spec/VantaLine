...
metadata ordering, cleanup and failure residue are retained. Source manifest v56 includes these producers.
...
retry or cancel is added. Source manifest v56 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v56 covers those relocated producers. No worker
...
source fingerprints use manifest v56, while historical task references remain untouched.
