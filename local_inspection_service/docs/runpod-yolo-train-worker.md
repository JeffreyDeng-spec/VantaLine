...
metadata ordering, cleanup and failure residue are retained. Source manifest v80 includes these producers.
...
retry or cancel is added. Source manifest v80 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v80 covers those relocated producers. No worker
...
source fingerprints use manifest v80, while historical task references remain untouched.
