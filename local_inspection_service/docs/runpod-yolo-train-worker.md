...
metadata ordering, cleanup and failure residue are retained. Source manifest v58 includes these producers.
...
retry or cancel is added. Source manifest v58 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v58 covers those relocated producers. No worker
...
source fingerprints use manifest v58, while historical task references remain untouched.
