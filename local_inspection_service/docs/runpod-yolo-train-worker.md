...
metadata ordering, cleanup and failure residue are retained. Source manifest v98 includes these producers.
...
retry or cancel is added. Source manifest v98 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v98 covers those relocated producers. No worker
...
source fingerprints use manifest v98, while historical task references remain untouched.
