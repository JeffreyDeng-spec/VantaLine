...
metadata ordering, cleanup and failure residue are retained. Source manifest v44 includes these producers.
...
retry or cancel is added. Source manifest v44 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v44 covers those relocated producers. No worker
...
source fingerprints use manifest v44, while historical task references remain untouched.
