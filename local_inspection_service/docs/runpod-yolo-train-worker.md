...
metadata ordering, cleanup and failure residue are retained. Source manifest v65 includes these producers.
...
retry or cancel is added. Source manifest v65 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v65 covers those relocated producers. No worker
...
source fingerprints use manifest v65, while historical task references remain untouched.
