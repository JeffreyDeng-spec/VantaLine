...
metadata ordering, cleanup and failure residue are retained. Source manifest v101 includes these producers.
...
retry or cancel is added. Source manifest v101 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v101 covers those relocated producers. No worker
...
source fingerprints use manifest v101, while historical task references remain untouched.
