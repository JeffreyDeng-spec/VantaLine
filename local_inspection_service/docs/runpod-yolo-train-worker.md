...
metadata ordering, cleanup and failure residue are retained. Source manifest v83 includes these producers.
...
retry or cancel is added. Source manifest v83 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v83 covers those relocated producers. No worker
...
source fingerprints use manifest v83, while historical task references remain untouched.
