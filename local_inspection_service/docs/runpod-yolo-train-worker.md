...
metadata ordering, cleanup and failure residue are retained. Source manifest v35 includes these producers.
...
retry or cancel is added. Source manifest v35 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v35 covers those relocated producers. No worker
...
source fingerprints use manifest v35, while historical task references remain untouched.
