...
metadata ordering, cleanup and failure residue are retained. Source manifest v42 includes these producers.
...
retry or cancel is added. Source manifest v42 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v42 covers those relocated producers. No worker
...
source fingerprints use manifest v42, while historical task references remain untouched.
