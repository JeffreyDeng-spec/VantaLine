...
metadata ordering, cleanup and failure residue are retained. Source manifest v43 includes these producers.
...
retry or cancel is added. Source manifest v43 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v43 covers those relocated producers. No worker
...
source fingerprints use manifest v43, while historical task references remain untouched.
