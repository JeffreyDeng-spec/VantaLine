...
metadata ordering, cleanup and failure residue are retained. Source manifest v53 includes these producers.
...
retry or cancel is added. Source manifest v53 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v53 covers those relocated producers. No worker
...
source fingerprints use manifest v53, while historical task references remain untouched.
