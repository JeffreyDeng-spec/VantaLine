...
metadata ordering, cleanup and failure residue are retained. Source manifest v79 includes these producers.
...
retry or cancel is added. Source manifest v79 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v79 covers those relocated producers. No worker
...
source fingerprints use manifest v79, while historical task references remain untouched.
