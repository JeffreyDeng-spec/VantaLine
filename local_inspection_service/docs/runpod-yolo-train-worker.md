...
metadata ordering, cleanup and failure residue are retained. Source manifest v66 includes these producers.
...
retry or cancel is added. Source manifest v66 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v66 covers those relocated producers. No worker
...
source fingerprints use manifest v66, while historical task references remain untouched.
