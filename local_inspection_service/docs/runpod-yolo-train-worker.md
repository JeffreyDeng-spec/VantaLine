...
metadata ordering, cleanup and failure residue are retained. Source manifest v86 includes these producers.
...
retry or cancel is added. Source manifest v86 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v86 covers those relocated producers. No worker
...
source fingerprints use manifest v86, while historical task references remain untouched.
