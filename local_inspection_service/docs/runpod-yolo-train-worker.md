...
metadata ordering, cleanup and failure residue are retained. Source manifest v92 includes these producers.
...
retry or cancel is added. Source manifest v92 and historical task binding rules apply.
...
contracts are unchanged. Source manifest v92 covers those relocated producers. No worker
...
source fingerprints use manifest v92, while historical task references remain untouched.
