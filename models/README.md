...
This folder stores small deployable reference weights for the bundled reference
task.
...
New task models are generated by the service and are normally stored under:
