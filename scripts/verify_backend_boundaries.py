...
PACKAGES = ('model_providers', 'model_profiles', 'runtime', 'schemas', 'analytics', 'auth', 'records', 'accessories', 'label_inspection', 'codex_compare', 'text_inspection', 'agent', 'detection', 'training', 'pipeline')
