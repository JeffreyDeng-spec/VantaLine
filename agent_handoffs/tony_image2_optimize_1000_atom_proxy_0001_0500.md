# Image2 Optimize 1000 Atom Proxy Dataset: Tony 0001-0500

Owner request: use AI/Image2 to optimize the randomized proxy sketches into realistic training photos.

You are not alone in this folder. Jesse is handling `0501-1000`. Do not overwrite Jesse's range. Do not revert or modify files outside your assigned range.
