# Tony Reactivation: Repair Known Errors + Bottle Shape Audit
...
`/mnt/f/CodexWorkspace/assembly_line_optimize/agent_handoffs/image2_ai_only_pipeline/tony_shape_material_repair_audit_tasks.csv`
...
1. Finish the previous upright-scale correction.
   - Known Tony-side blocker: `img2-0504`.
