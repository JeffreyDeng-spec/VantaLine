# Tony task: Image2 optimize 01-16

Owner request from T J.:
Use Image2 to optimize the first half of the 31 synthetic item-combination photos.

Your range:
- Input files: `F:\CodexWorkspace\assembly_line_optimize\synthetic_31_item_proxy_combinations\01*.png` through `16*.png`
- Output directory: `F:\CodexWorkspace\assembly_line_optimize\image2_optimized_31_item_combinations\`
- Output filenames must preserve the same basename, e.g. `01__bottle_proxy.png`
...
- Exactly 16 output PNGs exist for files 01-16.
